...
mixin _$TagsModel {
  ...
  TagGroupsModel get tagGroup => throw _privateConstructorUsedError;
...
abstract class $TagsModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, int orderNo, TagGroupsModel tagGroup});

  $TagGroupsModelCopyWith<$Res> get tagGroup;
}
...
class _$TagsModelCopyWithImpl<$Res, $Val extends TagsModel>
  ...
  @pragma('vm:prefer-inline')
  $TagGroupsModelCopyWith<$Res> get tagGroup {
    return $TagGroupsModelCopyWith<$Res>(_value.tagGroup, (value) {
      return _then(_value.copyWith(tagGroup: value) as $Val);
    });
  }
}
...
class _$TagsModelImpl implements _TagsModel {
  ...
  final int orderNo;
  @override
  final TagGroupsModel tagGroup;

  @override
  String toString() {
    return 'TagsModel(id: $id, name: $name, orderNo: $orderNo, tagGroup: $tagGroup)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.tagGroup, tagGroup) ||
                other.tagGroup == tagGroup));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, orderNo, tagGroup);
...
abstract class _TagsModel implements TagsModel {
  const factory _TagsModel(
      ...
      required final TagGroupsModel tagGroup}) = _$TagsModelImpl;
